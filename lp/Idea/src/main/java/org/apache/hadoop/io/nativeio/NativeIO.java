...
public class NativeIO {
    ...
    public static String getOwner(FileDescriptor fd) throws IOException {
        ...
        if(Shell.WINDOWS) {
            ...
            org.apache.hadoop.io.nativeio.NativeIO.CachedUid cUid = (org.apache.hadoop.io.nativeio.NativeIO.CachedUid)uidCache.get(Long.valueOf(uid));
    ...
    public static FileOutputStream getCreateForWriteFileOutputStream(File f, int permissions) throws IOException {
        ...
        if(!Shell.WINDOWS) {
            try {
                fd = org.apache.hadoop.io.nativeio.NativeIO.POSIX.open(f.getAbsolutePath(), 193, permissions);
    ...
    public static class POSIX {
        ...
        private static String getName(org.apache.hadoop.io.nativeio.NativeIO.POSIX.IdCache domain, int id) throws IOException {
            ...
            org.apache.hadoop.io.nativeio.NativeIO.POSIX.CachedName cachedName = (org.apache.hadoop.io.nativeio.NativeIO.POSIX.CachedName)idNameCache.get(Integer.valueOf(id));
            long now = System.currentTimeMillis();
            String name;
